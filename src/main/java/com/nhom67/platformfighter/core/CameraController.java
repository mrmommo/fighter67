...
public class CameraController {
    ...
    private final double zoomMin = 0.70;   // Zoom out khi xa nhau
    private final double zoomMax = 1.50;   // Zoom in khi lại gần
    ...
    public void update(double tpf) {
        ...
        if (!player1.isActive() || !player2.isActive()) return; // Tránh lỗi khi player chết
    ...
    private void applyCamera() {
        ...
        // Then apply position. The Viewport X, Y represents the top-left corner in world space.
    ...
    public double getCameraX() { return currentCameraX; }
    public double getCameraY() { return currentCameraY; }
    public double getZoom() { return currentZoom; }
}